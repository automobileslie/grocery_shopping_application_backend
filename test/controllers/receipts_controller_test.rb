...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt" do
    assert_difference('Receipt.count') do
      post receipts_url, params: { receipt: { retailer: @receipt.retailer, total: @receipt.total } }
    end
  ...
  test "should update receipt" do
    patch receipt_url(@receipt), params: { receipt: { retailer: @receipt.retailer, total: @receipt.total } }
