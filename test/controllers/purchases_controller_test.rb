...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { item_id: @purchase.item_id, receipt_id: @purchase.receipt_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { item_id: @purchase.item_id, receipt_id: @purchase.receipt_id } }
